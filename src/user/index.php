...
<body>
   ...
   <!-- Panel Start -->
    <div class="col-md-12 col-lg-12">
        <div class="img_container" style="display: flex; justify-content: center; position: relative; margin-top: 0px;"> 

            <img src="./img/trang chủ.png" alt=""
                style="margin-top: 0px; max-width: 100%; max-height: 80vh; height: auto; width: auto; object-fit: contain; border-radius: 12px; box-shadow: 0 0 40px rgba(0,0,0,0.05);">
